...
const String ANDROID_PACKAGE_NAME = "edu.tjrac.swant.sd";
...
const String ANDROID_PRIVATE_FILE_PATH = "$ANDROID_DATA/$ANDROID_PACKAGE_NAME/files";
...
const String ANDROID_PUBLIC_STYLES_PATH = "$ANDROID_PRIVATE_FILE_PATH/styles";
