...
//
//   WebViewPage(this.title, this.url,{this.cookieManager,this.channels});
//
...
//         },
//         // todo js 调用 flutter 1
//         javascriptChannels:widget.channels,
//         // <JavascriptChannel>{
...
//     );
//   }
//   NavigationDecision interceptUrl(String url){
//     if(url.contains('www.jobbon.cn')){
//       launch(url);
